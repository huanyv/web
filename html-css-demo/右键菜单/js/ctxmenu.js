class ContextMenus {
    ...
    _bindLiClick (evt) {
        ...
        if (childrens && childrens.length === 0) {
            ...
            this.callback({ action: Key_, title: evt.target.innerText }, evt, this.events);
        }
    }
...
styleNode.innerHTML=".contextmenu{position:absolute;width:200px;margin:0;padding:0;background:#ffffff;border-radius:5px;list-style:none;box-shadow:0 15px 35px rgba(50,50,90,0.1),0 5px 15px rgba(0,0,0,0.07);z-index:999999;display:none}.contextmenu li{border-left:3px solid transparent;transition:all 0.2s ease-out}.contextmenu li{display:block;padding:10px;color:#333;text-decoration:none;display:flex;justify-content:space-between;position:relative}.contextmenu li:hover{background:#eee;border-left:3px solid #3a8df5;cursor:pointer}.contextmenu li:hover{color:#333}";
